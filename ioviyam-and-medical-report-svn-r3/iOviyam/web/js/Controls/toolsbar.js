...
$(document).on("pageshow", "#viewerPage", function() {
    $.mobile.loading("show", {
        text: "Loading....",
        textVisible: true,
        theme: "b",
...
function unBindwlwc() {
    wlwwflage = false;
    $('#imgcanvas').unbind('touchmove', wlstartx);
    $('#imgcanvas').unbind('touchend', wlendx);
    $('#imgcanvas').unbind('touchstart', wlmovex);
    $('#imgcanvas').unbind('mousemove', wlstarty);
    $('#imgcanvas').unbind('mouseend', wlendy);
    $('#imgcanvas').unbind('mousestart', wlmovey);
}
...
//    $.mobile.showPageLoadingMsg();
    loadPixel(true);
//    console.log("__________Window levels startede binded__");
    $('#imgcanvas').bind('mousemove', wlstarty);
    $('#imgcanvas').bind('mouseup', wlendy);
    $('#imgcanvas').bind('mousedown', wlmovey);

    $('#imgcanvas').bind('touchmove', wlstartx);
    $('#imgcanvas').bind('touchend', wlendx);
    $('#imgcanvas').bind('touchstart', wlmovex);
...
function resizewindow() {
    ...
    $(".ui-slider-track").css("margin-left", "10px");
    $(".ui-slider-track").css("margin-right", "9px");
    $(".ui-slider-track").css('background', 'transparent');


//    $("#backbtns").addClass("ui-corner-flat");
    $.mobile.loading("show", {
        text: "Loading....",
        textVisible: true,
        theme: "b",
