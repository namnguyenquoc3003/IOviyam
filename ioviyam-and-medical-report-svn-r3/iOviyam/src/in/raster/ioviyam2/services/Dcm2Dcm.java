...
//import raster.dcm4chetool.*;
//import RasterDicomConverter.Query;
...
public class Dcm2Dcm {
    ...
    private static CommandLine parse(String[] args) {
        ...
        try {
            ...
            System.out.println("dcm2dcm: " + e.getMessage());
...
//                System.out.println("dcm2dcm: when converting several files, "
